...
build = {
   type = "builtin",
   modules = {
      basic_stuff = "basic_stuff.lua",
      codegen_eh_cache = "codegen_eh_cache.lua",
      core_utils = "core_utils.lua",
      date_utils = "date_utils.lua",
      eh_cache = "eh_cache.lua",
      elem_code_generator = "elem_code_generator.lua",
      error_handler = "error_handler.lua",
      facets = "facets.lua",
      generate_schema = "generate_schema.lua",
      message_handler_factory = "message_handler_factory.lua",
      nsd_cache = "nsd_cache.lua",
      number_utils = "number_utils.lua",
      ...
      stack = "stack.lua",
      struct_from_loe = "struct_from_loe.lua",
      type_code_generator = "type_code_generator.lua"
   }
}
