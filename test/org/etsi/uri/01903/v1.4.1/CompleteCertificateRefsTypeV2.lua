...
element_handler.__name__ = 'CompleteCertificateRefsTypeV2';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.4.1#}CompleteCertificateRefsTypeV2', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.4.1#}CompleteCertificateRefsTypeV2';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.4.1#'
    element_handler.properties.q_name.local_name = 'CompleteCertificateRefsTypeV2'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.4.1#}CertRefs', generated_symbol_name = '{http://uri.etsi.org/01903/v1.4.1#}CertRefs', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'CertRefs', cm = element_handler.properties.content_model}
...
do
    element_handler.properties.declared_subelements = {
        '{http://uri.etsi.org/01903/v1.4.1#}CertRefs'
    };
end
...
do
    ...
    do
        element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.4.1#}CertRefs'] = 
            (basic_stuff.get_element_handler('http://uri.etsi.org/01903/v1.3.2#', 'CertIDListV2Type'):
            new_instance_as_local_element({ns = 'http://uri.etsi.org/01903/v1.4.1#', local_name = 'CertRefs', generated_name = 'CertRefs',
...
do
    element_handler.properties.generated_subelements = {
        ['CertRefs'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.4.1#}CertRefs']
    };
end
