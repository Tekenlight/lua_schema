...
element_handler.__name__ = 'CounterSignatureType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}CounterSignatureType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}CounterSignatureType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'CounterSignatureType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://www.w3.org/2000/09/xmldsig#}Signature', generated_symbol_name = '{http://www.w3.org/2000/09/xmldsig#}Signature', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'Signature', cm = element_handler.properties.content_model}
...
do
    ...
    do
        element_handler.properties.subelement_properties['{http://www.w3.org/2000/09/xmldsig#}Signature'] = 
        (basic_stuff.get_element_handler('http://www.w3.org/2000/09/xmldsig#', 'Signature'):
            new_instance_as_ref({root_element=false, generated_name = 'Signature',
...
do
    element_handler.properties.generated_subelements = {
        ['Signature'] = element_handler.properties.subelement_properties['{http://www.w3.org/2000/09/xmldsig#}Signature']
    };
end
