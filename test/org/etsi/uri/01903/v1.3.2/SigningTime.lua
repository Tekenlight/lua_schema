...
_factory.new_instance_as_ref = function(self, element_ref_properties)
    return basic_stuff.instantiate_element_as_ref(mt, { ns = 'http://uri.etsi.org/01903/v1.3.2#',
                                                        local_name = 'SigningTime',
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}SigningTime', _factory);

element_handler.super_element_content_type = require('org.w3.2001.XMLSchema.dateTime_handler'):instantiate();
...
do
    ...
    element_handler.properties.schema_type = '{http://www.w3.org/2001/XMLSchema}dateTime';
    element_handler.properties.bi_type = {};
    element_handler.properties.bi_type.ns = 'http://www.w3.org/2001/XMLSchema';
    element_handler.properties.bi_type.name = 'dateTime';
    element_handler.properties.bi_type.id = '11';
...
do
    ...
    element_handler.particle_properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#';
    element_handler.particle_properties.q_name.local_name = 'SigningTime';
    element_handler.particle_properties.generated_name = 'SigningTime';
end
...
do
    ...
    element_handler.base.name = 'dateTime';
    element_handler.local_facets = {};
    element_handler.facets = basic_stuff.inherit_facets(element_handler);
end

do
    element_handler.type_handler = require('org.w3.2001.XMLSchema.dateTime_handler'):instantiate();
