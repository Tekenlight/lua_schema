...
element_handler.__name__ = 'UnsignedDataObjectPropertiesType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectPropertiesType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectPropertiesType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'UnsignedDataObjectPropertiesType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperty', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperty', min_occurs = 1, max_occurs = -1, wild_card_type = 0, generated_name = 'UnsignedDataObjectProperty', cm = element_handler.properties.content_model}
...
do
    element_handler.properties.declared_subelements = {
        '{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperty'
    };
end
...
do
    ...
    do
        element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperty'] = 
            (basic_stuff.get_element_handler('http://uri.etsi.org/01903/v1.3.2#', 'AnyType'):
            new_instance_as_local_element({ns = 'http://uri.etsi.org/01903/v1.3.2#', local_name = 'UnsignedDataObjectProperty', generated_name = 'UnsignedDataObjectProperty',
...
do
    element_handler.properties.generated_subelements = {
        ['UnsignedDataObjectProperty'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperty']
    };
end
