...
local _factory = {};
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}IndividualDataObjectsTimeStamp', _factory);
...
function _factory:new_instance_as_root()
    ...
    local obj =  type_handler:new_instance_as_global_element({
                                        ...
                                        local_name = 'IndividualDataObjectsTimeStamp',
                                        generated_name = 'IndividualDataObjectsTimeStamp',
                                        root_element = true,
                                        min_occurs = 1,
                                        max_occurs = 1});
    return obj;
