...
element_handler.__name__ = 'GenericTimeStampType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}GenericTimeStampType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}GenericTimeStampType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'GenericTimeStampType'
...
do
    element_handler.properties.content_model = {
        ...
        {
            generated_subelement_name = '_choice_group_1',
            group_type = 'C',
            min_occurs = 1,
            max_occurs = -1,
            top_level_group = false,
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'cm_begin', symbol_name = '_choice_group', generated_symbol_name = '_choice_group', min_occurs = 0, max_occurs = 1, cm = element_handler.properties.content_model[1]}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}Include', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}Include', min_occurs = 0, max_occurs = -1, wild_card_type = 0, generated_name = 'Include', cm = element_handler.properties.content_model[1]}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}ReferenceInfo', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}ReferenceInfo', min_occurs = 1, max_occurs = -1, wild_card_type = 0, generated_name = 'ReferenceInfo', cm = element_handler.properties.content_model[1]}
        ...
        ,{symbol_type = 'cm_begin', symbol_name = '_choice_group', generated_symbol_name = '_choice_group_1', min_occurs = 1, max_occurs = -1, cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}EncapsulatedTimeStamp', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}EncapsulatedTimeStamp', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'EncapsulatedTimeStamp', cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}XMLTimeStamp', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}XMLTimeStamp', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'XMLTimeStamp', cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'cm_end', symbol_name = '_choice_group', generated_symbol_name = '_choice_group_1', cm_begin_index = 7, cm = element_handler.properties.content_model[2]}
...
do
    element_handler.properties.declared_subelements = {
        ...
        ,'{http://uri.etsi.org/01903/v1.3.2#}ReferenceInfo'
...
do
    element_handler.properties.generated_subelements = {
        ...
        ,['ReferenceInfo'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}ReferenceInfo']
