...
element_handler.__name__ = 'RevocationValuesType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}RevocationValuesType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}RevocationValuesType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'RevocationValuesType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}CRLValues', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}CRLValues', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'CRLValues', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}OCSPValues', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}OCSPValues', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'OCSPValues', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}OtherValues', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}OtherValues', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'OtherValues', cm = element_handler.properties.content_model}
...
do
    element_handler.properties.declared_subelements = {
        ...
        ,'{http://uri.etsi.org/01903/v1.3.2#}OCSPValues'
        ,'{http://uri.etsi.org/01903/v1.3.2#}OtherValues'
    };
end
...
do
    element_handler.properties.generated_subelements = {
        ['CRLValues'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}CRLValues']
        ,['OCSPValues'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}OCSPValues']
        ,['OtherValues'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}OtherValues']
    };
end
