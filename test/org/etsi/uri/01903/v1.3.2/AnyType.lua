...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}AnyType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}AnyType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'AnyType'
    ...
    element_handler.properties.attr.attr_wildcard = {};
    element_handler.properties.attr.attr_wildcard.any = 1;
    element_handler.properties.attr.attr_wildcard.process_contents = 3;
    element_handler.properties.attr.attr_wildcard.ns_set = {};
    element_handler.properties.attr.attr_wildcard.neg_ns_set = {};
end
