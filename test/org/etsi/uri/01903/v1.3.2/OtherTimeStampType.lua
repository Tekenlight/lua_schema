...
element_handler.__name__ = 'OtherTimeStampType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}OtherTimeStampType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}OtherTimeStampType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'OtherTimeStampType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}ReferenceInfo', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}ReferenceInfo', min_occurs = 1, max_occurs = -1, wild_card_type = 0, generated_name = 'ReferenceInfo', cm = element_handler.properties.content_model}
