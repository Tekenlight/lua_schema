...
element_handler.__name__ = 'SignedPropertiesType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}SignedPropertiesType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}SignedPropertiesType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'SignedPropertiesType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}SignedSignatureProperties', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}SignedSignatureProperties', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'SignedSignatureProperties', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}SignedDataObjectProperties', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}SignedDataObjectProperties', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'SignedDataObjectProperties', cm = element_handler.properties.content_model}
...
do
    ...
    do
        element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}SignedSignatureProperties'] = 
        (basic_stuff.get_element_handler('http://uri.etsi.org/01903/v1.3.2#', 'SignedSignatureProperties'):
            new_instance_as_ref({root_element=false, generated_name = 'SignedSignatureProperties',
                    min_occurs = 0, max_occurs = 1}));
    end

    do
        element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}SignedDataObjectProperties'] = 
        (basic_stuff.get_element_handler('http://uri.etsi.org/01903/v1.3.2#', 'SignedDataObjectProperties'):
            new_instance_as_ref({root_element=false, generated_name = 'SignedDataObjectProperties',
                    min_occurs = 0, max_occurs = 1}));
    end
...
do
    element_handler.properties.generated_subelements = {
        ['SignedSignatureProperties'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}SignedSignatureProperties']
        ,['SignedDataObjectProperties'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}SignedDataObjectProperties']
    };
end
