...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}SignedDataObjectPropertiesType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}SignedDataObjectPropertiesType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'SignedDataObjectPropertiesType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}DataObjectFormat', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}DataObjectFormat', min_occurs = 0, max_occurs = -1, wild_card_type = 0, generated_name = 'DataObjectFormat', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}CommitmentTypeIndication', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}CommitmentTypeIndication', min_occurs = 0, max_occurs = -1, wild_card_type = 0, generated_name = 'CommitmentTypeIndication', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}AllDataObjectsTimeStamp', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}AllDataObjectsTimeStamp', min_occurs = 0, max_occurs = -1, wild_card_type = 0, generated_name = 'AllDataObjectsTimeStamp', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}IndividualDataObjectsTimeStamp', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}IndividualDataObjectsTimeStamp', min_occurs = 0, max_occurs = -1, wild_card_type = 0, generated_name = 'IndividualDataObjectsTimeStamp', cm = element_handler.properties.content_model}
...
do
    element_handler.properties.declared_subelements = {
        '{http://uri.etsi.org/01903/v1.3.2#}DataObjectFormat'
        ,'{http://uri.etsi.org/01903/v1.3.2#}CommitmentTypeIndication'
        ,'{http://uri.etsi.org/01903/v1.3.2#}AllDataObjectsTimeStamp'
        ,'{http://uri.etsi.org/01903/v1.3.2#}IndividualDataObjectsTimeStamp'
        ,'{}any'
    };
end
...
do
    element_handler.properties.generated_subelements = {
        ['DataObjectFormat'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}DataObjectFormat']
        ,['CommitmentTypeIndication'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}CommitmentTypeIndication']
        ,['AllDataObjectsTimeStamp'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}AllDataObjectsTimeStamp']
        ,['IndividualDataObjectsTimeStamp'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}IndividualDataObjectsTimeStamp']
    };
end
