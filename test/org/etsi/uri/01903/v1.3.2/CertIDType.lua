...
element_handler.__name__ = 'CertIDType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}CertIDType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}CertIDType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'CertIDType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}IssuerSerial', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}IssuerSerial', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'IssuerSerial', cm = element_handler.properties.content_model}
...
do
    ...
    do
        element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}IssuerSerial'] = 
            (basic_stuff.get_element_handler('http://www.w3.org/2000/09/xmldsig#', 'X509IssuerSerialType'):
            new_instance_as_local_element({ns = 'http://uri.etsi.org/01903/v1.3.2#', local_name = 'IssuerSerial', generated_name = 'IssuerSerial',
...
do
    element_handler.properties.generated_subelements = {
        ...
        ,['IssuerSerial'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}IssuerSerial']
    };
end
