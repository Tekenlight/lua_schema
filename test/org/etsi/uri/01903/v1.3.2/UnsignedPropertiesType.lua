...
element_handler.__name__ = 'UnsignedPropertiesType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}UnsignedPropertiesType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedPropertiesType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'UnsignedPropertiesType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedSignatureProperties', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedSignatureProperties', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'UnsignedSignatureProperties', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperties', generated_symbol_name = '{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperties', min_occurs = 0, max_occurs = 1, wild_card_type = 0, generated_name = 'UnsignedDataObjectProperties', cm = element_handler.properties.content_model}
...
do
    element_handler.properties.declared_subelements = {
        ...
        ,'{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperties'
    };
end
...
do
    element_handler.properties.generated_subelements = {
        ['UnsignedSignatureProperties'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}UnsignedSignatureProperties']
        ,['UnsignedDataObjectProperties'] = element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}UnsignedDataObjectProperties']
    };
end
