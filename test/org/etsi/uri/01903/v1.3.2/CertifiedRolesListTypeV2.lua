...
element_handler.__name__ = 'CertifiedRolesListTypeV2';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}CertifiedRolesListTypeV2', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}CertifiedRolesListTypeV2';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'CertifiedRolesListTypeV2'
...
do
    ...
    do
        element_handler.properties.subelement_properties['{http://uri.etsi.org/01903/v1.3.2#}CertifiedRole'] = 
            (basic_stuff.get_element_handler('http://uri.etsi.org/01903/v1.3.2#', 'CertifiedRoleTypeV2'):
            new_instance_as_local_element({ns = 'http://uri.etsi.org/01903/v1.3.2#', local_name = 'CertifiedRole', generated_name = 'CertifiedRole',
