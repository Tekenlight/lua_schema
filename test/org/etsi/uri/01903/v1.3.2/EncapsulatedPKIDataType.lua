...
element_handler.__name__ = 'EncapsulatedPKIDataType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}EncapsulatedPKIDataType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}EncapsulatedPKIDataType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'EncapsulatedPKIDataType'
