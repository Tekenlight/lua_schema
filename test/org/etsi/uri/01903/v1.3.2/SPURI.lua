...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}SPURI', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://www.w3.org/2001/XMLSchema}anyURI';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'SPURI';
    element_handler.particle_properties.generated_name = 'SPURI';
end
