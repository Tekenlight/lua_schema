...
element_handler.__name__ = 'QualifierType';
...
eh_cache.add('{http://uri.etsi.org/01903/v1.3.2#}QualifierType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://uri.etsi.org/01903/v1.3.2#}QualifierType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://uri.etsi.org/01903/v1.3.2#'
    element_handler.properties.q_name.local_name = 'QualifierType'
...
do
    ...
    element_handler.local_facets.enumeration[1] = 'OIDAsURI';
    element_handler.local_facets.enumeration[2] = 'OIDAsURN';
