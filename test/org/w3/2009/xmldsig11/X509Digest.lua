...
local _factory = {};
eh_cache.add('{http://www.w3.org/2009/xmldsig11#}X509Digest', _factory);



function _factory:new_instance_as_root()
    local type_handler = basic_stuff.get_element_handler('http://www.w3.org/2009/xmldsig11#', 'X509DigestType');
    local obj =  type_handler:new_instance_as_global_element({
                                        ns = 'http://www.w3.org/2009/xmldsig11#',
                                        local_name = 'X509Digest',
                                        generated_name = 'X509Digest',
                                        root_element = true,
                                        min_occurs = 1,
                                        max_occurs = 1});
    return obj;
