...
local _factory = {};
eh_cache.add('{http://www.w3.org/2009/xmldsig11#}PnB', _factory);



function _factory:new_instance_as_root()
    local type_handler = basic_stuff.get_element_handler('http://www.w3.org/2009/xmldsig11#', 'PnBFieldParamsType');
