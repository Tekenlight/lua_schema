...
element_handler.__name__ = 'DigestMethodType';
...
eh_cache.add('{http://www.w3.org/2000/09/xmldsig#}DigestMethodType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://www.w3.org/2000/09/xmldsig#}DigestMethodType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://www.w3.org/2000/09/xmldsig#'
    element_handler.properties.q_name.local_name = 'DigestMethodType'
