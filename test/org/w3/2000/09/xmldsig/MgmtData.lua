...
_factory.new_instance_as_ref = function(self, element_ref_properties)
    return basic_stuff.instantiate_element_as_ref(mt, { ns = 'http://www.w3.org/2000/09/xmldsig#',
                                                        local_name = 'MgmtData',
...
eh_cache.add('{http://www.w3.org/2000/09/xmldsig#}MgmtData', _factory);
...
do
    ...
    element_handler.particle_properties.q_name.ns = 'http://www.w3.org/2000/09/xmldsig#';
    element_handler.particle_properties.q_name.local_name = 'MgmtData';
    element_handler.particle_properties.generated_name = 'MgmtData';
end
