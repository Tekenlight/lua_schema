...
element_handler.__name__ = 'HMACOutputLengthType';
...
eh_cache.add('{http://www.w3.org/2000/09/xmldsig#}HMACOutputLengthType', _factory);


element_handler.super_element_content_type = require('org.w3.2001.XMLSchema.integer_handler'):instantiate();
...
do
    ...
    element_handler.properties.schema_type = '{http://www.w3.org/2000/09/xmldsig#}HMACOutputLengthType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://www.w3.org/2000/09/xmldsig#'
    element_handler.properties.q_name.local_name = 'HMACOutputLengthType'
    element_handler.properties.bi_type = {};
    element_handler.properties.bi_type.ns = 'http://www.w3.org/2001/XMLSchema';
    element_handler.properties.bi_type.name = 'integer';
...
do
    ...
    element_handler.base.name = 'integer';
    element_handler.local_facets = {};
    element_handler.facets = basic_stuff.inherit_facets(element_handler);
end

do
    element_handler.type_handler = require('org.w3.2001.XMLSchema.integer_handler'):instantiate();
