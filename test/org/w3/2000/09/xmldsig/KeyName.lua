...
eh_cache.add('{http://www.w3.org/2000/09/xmldsig#}KeyName', _factory);
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'KeyName';
    element_handler.particle_properties.generated_name = 'KeyName';
end
