...
eh_cache.add('{http://www.w3.org/2000/09/xmldsig#}KeyValueType', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://www.w3.org/2000/09/xmldsig#}KeyValueType';
    element_handler.properties.q_name = {};
    element_handler.properties.q_name.ns = 'http://www.w3.org/2000/09/xmldsig#'
    element_handler.properties.q_name.local_name = 'KeyValueType'
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{http://www.w3.org/2000/09/xmldsig#}DSAKeyValue', generated_symbol_name = '{http://www.w3.org/2000/09/xmldsig#}DSAKeyValue', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'DSAKeyValue', cm = element_handler.properties.content_model}
        ,{symbol_type = 'element', symbol_name = '{http://www.w3.org/2000/09/xmldsig#}RSAKeyValue', generated_symbol_name = '{http://www.w3.org/2000/09/xmldsig#}RSAKeyValue', min_occurs = 1, max_occurs = 1, wild_card_type = 0, generated_name = 'RSAKeyValue', cm = element_handler.properties.content_model}
...
do
    element_handler.properties.generated_subelements = {
        ['DSAKeyValue'] = element_handler.properties.subelement_properties['{http://www.w3.org/2000/09/xmldsig#}DSAKeyValue']
        ,['RSAKeyValue'] = element_handler.properties.subelement_properties['{http://www.w3.org/2000/09/xmldsig#}RSAKeyValue']
    };
end
