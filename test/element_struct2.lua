...
eh_cache.add('{}element_struct2', _factory);
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'element_struct2';
    element_handler.particle_properties.generated_name = 'element_struct2';
end
