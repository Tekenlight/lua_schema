...
eh_cache.add('{}basic_token_nons', _factory);
...
do
    ...
    element_handler.properties.schema_type = '{http://www.w3.org/2001/XMLSchema}token';
    ...
    element_handler.properties.bi_type.id = '16';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'basic_token_nons';
    element_handler.particle_properties.generated_name = 'basic_token_nons';
end
