...
local content = {s2 = {{author = "A43", title = "A44", genre = "A45"}}, element_struct2 = {author = "123", title = "234", genre =   "345"},  _attr = {}, author = {"asdf", "asdf"}, author_1=ffi.new("int",12), title = "adfas", genre="asdf", basic_string_simple_content = {_attr = {attr1 = ffi.new("int", 123), attr2 = "CHA"}, _contained_value = "GOWRI" } };
