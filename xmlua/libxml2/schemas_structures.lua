...
/*
   THESE ARE STRUCTURES USED FOR HOLDING ATTRIBUTE
   DECLARATIONS WITHIN COMPLEX TYPES
*/
...
/*
   THESE ARE STRUCTURES USED FOR BEING ABLE TO HANDLE
   STRUCTURE OF ELEMENT DECLARATIONS AND TYPE DEFINITIONS
*/
