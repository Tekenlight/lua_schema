...
require("lua_schema.xmlua.libxml2.memory")
require("lua_schema.xmlua.libxml2.global")
require("lua_schema.xmlua.libxml2.xmlstring")
require("lua_schema.xmlua.libxml2.xmlerror")
require("lua_schema.xmlua.libxml2.dict")
require("lua_schema.xmlua.libxml2.hash")
require("lua_schema.xmlua.libxml2.tree")
require("lua_schema.xmlua.libxml2.valid")
require("lua_schema.xmlua.libxml2.encoding")
require("lua_schema.xmlua.libxml2.parser")
require("lua_schema.xmlua.libxml2.html-parser")
require("lua_schema.xmlua.libxml2.html-tree")
require("lua_schema.xmlua.libxml2.xmlsave")
require("lua_schema.xmlua.libxml2.xpath")
require("lua_schema.xmlua.libxml2.entities")
require("lua_schema.xmlua.libxml2.schemas")
require("lua_schema.xmlua.libxml2.relaxng")
require("lua_schema.xmlua.libxml2.reader")
require("lua_schema.xmlua.libxml2.reader")
require("lua_schema.xmlua.libxml2.schemas")
require("lua_schema.xmlua.libxml2.xmlregexp")
require("lua_schema.xmlua.libxml2.schemas_structures")
require("lua_schema.xmlua.libxml2.xmlschemastypes")
...
function libxml2.xmlNewComment(content)
	local new_comment = xml2.xmlNewComment(content)
...
function libxml2.xmlCreateIntSubset(document,
                                    ...
                                    external_id,
                                    system_id)
	local new_dtd = xml2.xmlCreateIntSubset(document,
							name,
							external_id,
							system_id)
...
function libxml2.xmlNewDocFragment(document)
	local new_document_fragment = xml2.xmlNewDocFragment(document)
	if new_document_fragment == ffi.NULL then
		return nil
	end
	return ffi.gc(new_document_fragment, libxml2.xmlFreeNode)
end

function libxml2.xmlNewReference(document, name)
	local new_reference = xml2.xmlNewReference(document, name)
	if new_reference == ffi.NULL then
		return nil
	end
	return ffi.gc(new_reference, libxml2.xmlFreeNode)
end
