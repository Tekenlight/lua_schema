...
local _content_fsa_properties = {
	{symbol_type = 'cm_begin', symbol_name = 'one_top', min_occurs = 1, max_occurs = 1, group_type = 'C', cm = _content_model}
	,{symbol_type = 'element', symbol_name = '{}one', min_occurs = 1, max_occurs = 1, cm = _content_model}
	,{symbol_type = 'cm_begin', symbol_name = 'author_title_and_genre', min_occurs = 1, max_occurs = 1, group_type = 'S', cm = _content_model[2]}
	,{symbol_type = 'element', symbol_name = '{}author', min_occurs = 1, max_occurs = 1, cm = _content_model[2]}
	,{symbol_type = 'element', symbol_name = '{}title', min_occurs = 1, max_occurs = 1, cm = _content_model[2]}
	,{symbol_type = 'element', symbol_name = '{}genre', min_occurs = 1, max_occurs = 1, cm = _content_model[2]}
	,{symbol_type = 'cm_end', symbol_name = 'author_title_and_genre', cm_begin_index=3, cm = _content_model[2]}
