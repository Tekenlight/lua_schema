...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}simple_sequence_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'simple_sequence_struct';
    element_handler.particle_properties.generated_name = 'simple_sequence_struct';
end
...
_factory.new_instance_as_ref = function(self, element_ref_properties)
    return basic_stuff.instantiate_element_as_ref(mt, { ns = 'http://test_example.com',
                                                        local_name = 'simple_sequence_struct',
