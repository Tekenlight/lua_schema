...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}seq_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'seq_struct';
    element_handler.particle_properties.generated_name = 'seq_struct';
end
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'cm_begin', symbol_name = '_sequence_group', generated_symbol_name = '_sequence_group_1', min_occurs = 1, max_occurs = -1, cm = element_handler.properties.content_model[3]}
        ...
        ,{symbol_type = 'cm_end', symbol_name = '_sequence_group', generated_symbol_name = '_sequence_group_1', cm_begin_index = 4, cm = element_handler.properties.content_model[3]}
