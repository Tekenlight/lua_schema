...
function _factory:new_instance_as_root()
    return require('com.test_example.mult_choice_struct_type'):new_instance_as_global_element({
...
function _factory:new_instance_as_ref(element_ref_properties)
    return require('com.test_example.mult_choice_struct_type'):new_instance_as_local_element({ ns = 'http://test_example.com',
                                                        local_name = 'mult_choice_struct',
