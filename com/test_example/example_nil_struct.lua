...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}example_nil_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'example_nil_struct';
    element_handler.particle_properties.generated_name = 'example_nil_struct';
end
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'element', symbol_name = '{}s2', generated_symbol_name = '{}s2', min_occurs = 0, max_occurs = -1, cm = element_handler.properties.content_model}
