...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}simple_choice1_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'simple_choice1_struct';
    element_handler.particle_properties.generated_name = 'simple_choice1_struct';
end
