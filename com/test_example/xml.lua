...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}xml';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'xml';
    element_handler.particle_properties.generated_name = 'xml';
end
...
-- element_handler.properties.subelement_properties['{}included_struct'].properties.content_fsa_properties
        ...
        do
            local subelement_properties = element_handler.properties.subelement_properties['{}included_struct'].properties.subelement_properties;
            element_handler.properties.subelement_properties['{}included_struct'].properties.generated_subelements = {
                one = subelement_properties[{}one]                three = subelement_properties[{}three]                two = subelement_properties[{}two]            element_handler.properties.subelement_properties['{}included_struct']};
        end
...
do
    local subelement_properties = element_handler.properties.subelement_properties;
    element_handler.properties.generated_subelements = {
        basic_string_simple_content = subelement_properties[{http://test_example.com}basic_string_simple_content]        genre = subelement_properties[{}genre]        element_struct2 = subelement_properties[{http://test_example1.com}element_struct2]        author_2 = subelement_properties[{}author_2]        included_struct = subelement_properties[{}included_struct]        author = subelement_properties[{}author]        author_1 = subelement_properties[{}author_1]        s2 = subelement_properties[{}s2]        title = subelement_properties[{}title]    element_handler};
end
