...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}xml_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'xml_struct';
    element_handler.particle_properties.generated_name = 'xml_struct';
end
