...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}sequence_ina_choice_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'sequence_ina_choice_struct';
    element_handler.particle_properties.generated_name = 'sequence_ina_choice_struct';
end
...
do
    element_handler.properties.content_fsa_properties = {
        ...
        ,{symbol_type = 'cm_begin', symbol_name = '_sequence_group', generated_symbol_name = '_sequence_group', min_occurs = 1, max_occurs = 1, cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'element', symbol_name = '{}author', generated_symbol_name = '{}author', min_occurs = 1, max_occurs = 1, cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'element', symbol_name = '{}title', generated_symbol_name = '{}title', min_occurs = 1, max_occurs = 1, cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'element', symbol_name = '{}genre', generated_symbol_name = '{}genre', min_occurs = 1, max_occurs = 1, cm = element_handler.properties.content_model[2]}
        ,{symbol_type = 'cm_end', symbol_name = '_sequence_group', generated_symbol_name = '_sequence_group', cm_begin_index = 3, cm = element_handler.properties.content_model[2]}
...
_factory.new_instance_as_ref = function(self, element_ref_properties)
    return basic_stuff.instantiate_element_as_ref(mt, { ns = 'http://test_example.com',
                                                        local_name = 'sequence_ina_choice_struct',
