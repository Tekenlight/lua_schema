...
do
    ...
    element_handler.properties.schema_type = '{http://test_example.com}choice_struct';
...
do
    ...
    element_handler.particle_properties.q_name.local_name = 'choice_struct';
    element_handler.particle_properties.generated_name = 'choice_struct';
end
