...
local _content_fsa_properties = {
	{symbol_type = 'cm_begin', symbol_name = 'one_top', generated_symbol_name = 'one_top', min_occurs = 1, max_occurs = 1, group_type = 'C', cm = _content_model}
	,{symbol_type = 'element', symbol_name = '{}one', generated_symbol_name = '{}one', min_occurs = 1, max_occurs = 1, cm = _content_model}
	,{symbol_type = 'cm_begin', symbol_name = 'author_title_and_genre', generated_symbol_name = 'author_title_and_genre', min_occurs = 1, max_occurs = 1, group_type = 'S', cm = _content_model[2]}
	,{symbol_type = 'element', symbol_name = '{}author', generated_symbol_name = '{}author', min_occurs = 1, max_occurs = 1, cm = _content_model[2]}
	,{symbol_type = 'element', symbol_name = '{}title', generated_symbol_name = '{}title', min_occurs = 1, max_occurs = 1, cm = _content_model[2]}
	,{symbol_type = 'element', symbol_name = '{}genre', generated_symbol_name = '{}genre', min_occurs = 1, max_occurs = 1, cm = _content_model[2]}
	,{symbol_type = 'cm_end', symbol_name = 'author_title_and_genre', generated_symbol_name = 'author_title_and_genre', cm_begin_index=3, cm = _content_model[2]}
...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example.prototype}sequence_ina_choice_struct', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example.prototype', local_name='sequence_ina_choice_struct'},
	generated_name = 'sequence_ina_choice_struct'
};
