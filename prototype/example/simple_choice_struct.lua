...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example.prototype}simple_choice_struct', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example.prototype', local_name='simple_choice_struct'},
	generated_name = 'simple_choice_struct'
};
...
function _factory:new_instance_as_ref(element_ref_properties)
	return basic_stuff.instantiate_element_as_ref(mt, { ns='http://example.prototype',
														local_name = 'simple_choice_struct',
														generated_name = 'simple_choice_struct',
