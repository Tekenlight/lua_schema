...
local _declared_sub_elements = { collection_type = 'S', -- 'S' ->Sequence, 'C' -> Choice, 'A' -> All
							 [1] = '{http://example1.prototype}element_struct2',
							 [2] = '{}author',
							 [3] = '{}title',
							 [4] = '{}genre',
							 [5] = '{}s2',
							 [6] = '{http://example.prototype}basic_string_simple_content'
						 };
--]]
...
local _all_generated_names = {
	['author_and_title'] = 1,
	['element_struct2'] = '{http://example1.prototype}element_struct2',
	['author'] = '{}author',
	['title'] = '{}title',
	['genre'] = '{}genre',
	['s2'] = '{}s2',
	['basic_string_simple_content'] = '{http://example.prototype}basic_string_simple_content'
};
...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example.prototype}example_struct', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example.prototype', local_name='example_struct'},
