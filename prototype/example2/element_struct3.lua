...
local _declared_sub_elements = {
	...
	'{}title',
	'{}genre',
	'{http://example.prototype}example_struct',
	'{http://example.prototype}basic_string',
	'{}basic_string_nons',
};
...
local _content_fsa_properties = {
	...
	,{symbol_type = 'element', symbol_name = '{http://example.prototype}example_struct', generated_symbol_name = '{http://example.prototype}example_struct', min_occurs = 1, max_occurs = 1, cm = _content_model}
	,{symbol_type = 'element', symbol_name = '{http://example.prototype}basic_string', generated_symbol_name = '{http://example.prototype}basic_string', min_occurs = 1, max_occurs = 1, cm = _content_model}
	,{symbol_type = 'element', symbol_name = '{}basic_string_nons', generated_symbol_name = '{}basic_string_nons', min_occurs = 1, max_occurs = 1, cm = _content_model}
...
local _subelement_properties = {
	...
	['{http://example.prototype}example_struct'] = (require('prototype.example.example_struct')):new_instance_as_ref(
																	{ generated_name = 'example_struct', root_element = false, min_occurs = 1, max_occurs = 1}),
	['{http://example.prototype}basic_string'] = (require('prototype.example.basic_string')):new_instance_as_ref(
																	{ generated_name = 'basic_string', root_element = false, min_occurs = 1, max_occurs = 1} ),
	['{}basic_string_nons'] = (require('basic_string_nons')):new_instance_as_ref(
																	{ generated_name = 'basic_string_nons', root_element = false, min_occurs = 1, max_occurs = 1}),
};
...
local _generated_sub_elements = {
	...
	['example_struct'] = _subelement_properties['{http://example.prototype}example_struct'],
	['basic_string'] = _subelement_properties['{http://example.prototype}basic_string'],
...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example2.prototype}element_struct3', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example2.prototype', local_name='element_struct3'},
...
function _factory:new_instance_as_ref(element_ref_properties)
	return basic_stuff.instantiate_element_as_ref(mt, { ns='http://example2.prototype',
