...
function _factory:new_instance_as_root()
	return (require('prototype.example1.struct2')):new_instance_as_global_element(
															{ns='http://example1.prototype',
...
function _factory:new_instance_as_ref(element_ref_properties)
	local o =  (require('prototype.example1.struct2')):new_instance_as_local_element({ns='http://example1.prototype',
																		local_name = 'element_struct2',
																		generated_name = 'element_struct2',
