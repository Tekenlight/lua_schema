...
local _content_fsa_properties = {
	...
	,{symbol_type = 'cm_begin', symbol_name = 'three_or_four', generated_symbol_name = 'three_or_four', min_occurs = 1, max_occurs = -1, group_type = 'C', cm = _content_model[3]}
	...
	,{symbol_type = 'cm_end', symbol_name = 'three_or_four', generated_symbol_name = 'three_or_four', cm_begin_index = 4, cm = _content_model[3]}
...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example.prototype}mult_choice_struct', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example.prototype', local_name='mult_choice_struct'},
