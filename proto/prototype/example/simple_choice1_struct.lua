...
local _content_fsa_properties = {
	{symbol_type = 'cm_begin', symbol_name = 'author_title_and_genre', generated_symbol_name = 'author_title_and_genre', min_occurs = 1, max_occurs = 1, group_type = 'C', cm = _content_model}
...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example.prototype}simple_choice1_struct', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example.prototype', local_name='simple_choice1_struct'},
	generated_name = 'simple_choice1_struct'
};
...
function _factory:new_instance_as_ref(element_ref_properties)
	return basic_stuff.instantiate_element_as_ref(mt, { ns='http://example.prototype',
														local_name = 'simple_choice1_struct',
														generated_name = 'simple_choice1_struct',
