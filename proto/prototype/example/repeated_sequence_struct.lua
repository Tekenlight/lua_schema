...
_struct_handler.properties = {
	element_type='C',
	content_type='C',
	schema_type = '{http://example.prototype}repeated_sequence_struct', --[[This is the name of the type
...
_struct_handler.particle_properties = {
	q_name={ns='http://example.prototype', local_name='repeated_sequence_struct'},
	generated_name = 'repeated_sequence_struct'
};
