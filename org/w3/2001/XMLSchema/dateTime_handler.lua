...
__datetime_handler_class.type_id = xml_datetime_utils.value_type.XML_SCHEMAS_DATE;
...
function __datetime_handler_class:to_type(ns, i)
	if ('string' ~= type(i)) then error("Field: {"..error_handler.get_fieldpath().."} Input not a valid datetime"); end
